...
var drop = function drop() {
  ...
  function highlight(item) {
    item.closest('.file_upload').style.border = "5px solid #E950D7";
...
var forms = function forms() {
  ...
  var message = {
    loading: 'Загрузка...',
    success: 'Спасибо! Наш специалист с вами свяжется.',
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      if (!btnPressed && window.pageXOffset + document.documentElement.clientHeight >= scrollHeight) {
